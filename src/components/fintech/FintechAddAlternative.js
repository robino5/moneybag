...
const FintechAdd = () => {
  ...
  const [Testservices, setTesttaddservices] = useState([]);
  ...
  const addServices = (e) => {
    ...
    // let data=addservices
    setTesttaddservices(addservices)
            ...
            <CCard className="p-4">
              ...
              <CCardBody>
                <CForm onSubmit={handleSubmit(saveFintech)}>
                  ...
                  <hr></hr>
                  {
                   Testservices&&Testservices.map((service)=>{
                     return(
                      <CRow>
                      <CCol sm={3}>
                    <p>{service.category_service_id}</p>
                      </CCol>
                      <CCol sm={3}>
